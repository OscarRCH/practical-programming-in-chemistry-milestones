...
| Week | Milestone                                   | Link                                                                        |      
|------|---------------------------------------------|-----------------------------------------------------------------------------|
| 1    | Github Account Created                      | https://github.com/OscarRCH                                                 | 
| 1    | Github Profile Page                         | https://github.com/OscarRCH                                                 |
| 1    | Commit and Push Change from Command Line    | https://github.com/OscarRCH/ppchem/commit/e6e15cb3f738b1853696fe064424b5ef0fd4a574|
| 1    | Create a New Branch                         | https://github.com/OscarRCH/ppchem/tree/new-branch-name                     |
| 1    | Create a conda environment                  | https://github.com/OscarRCH/ppchem/blob/main/env.yml                        |
| 1    | Fork a Repo                                 | https://github.com/OscarRCH/practical-programming-in-chemistry-milestones   |
| 1    | (Optional) Make a Pull Request              | |
| 2    | (Optional) Review a Pull Request            | |
| 4    | Update `env.yml` via a Pull Request         | https://github.com/OscarRCH/ppchem/pull/2 |
